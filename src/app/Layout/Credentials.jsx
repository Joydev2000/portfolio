  ...
  return (
    <section id="credentials" className="py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-16"><h2 className="text-sm font-bold text-blue-400 uppercase tracking-widest mb-3">03. Credentials</h2><h3 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-white tracking-tight">Resume Summary</h3></div>
          </ScrollReveal>
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <StaggerItem>
                  <div className="flex items-center mb-8 gap-4 border-b border-white/10 pb-4"><div className="w-10 h-10 rounded-full bg-purple-500/10 flex items-center justify-center text-purple-400"><i className="fas fa-briefcase text-lg"></i></div><h3 className="text-xl font-display font-bold text-white">Professional Skills</h3></div>
                  <div className="space-y-6">
