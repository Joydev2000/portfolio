          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
              <div className="lg:w-1/2 w-full relative group">
                  ...
                  <div className="relative glass-card rounded-3xl p-8 border border-white/10 aspect-square flex flex-col justify-center items-center text-center overflow-hidden">
                      ...
                      <h3 className="text-2xl font-display font-bold text-white mb-2 tracking-tight">Clean Architecture</h3>
                      <p className="text-slate-400 text-sm max-w-xs mb-8">I build scalable, maintainable systems that stand the test of time.</p>
              ...
              <div className="lg:w-1/2 w-full">
                  ...
                  <h3 className="text-4xl md:text-5xl font-display font-bold text-white mb-6 tracking-tight">Passionate about <br/> solving complex problems.</h3>
                  <p className="text-lg text-slate-400 mb-6 leading-relaxed font-light">My journey started with simple HTML pages and evolved into building complex, data-driven applications.</p>
                  <div className="space-y-6">
                      <div>
                          <div className="flex justify-between text-sm font-medium text-slate-300 mb-2"><span>Frontend</span><span>95%</span></div>
                      ...
                      <div>
                          <div className="flex justify-between text-sm font-medium text-slate-300 mb-2"><span>Backend</span><span>88%</span></div>
